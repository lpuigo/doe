...
func TestPolesiteFromXLS(t *testing.T) {
	psXlsfile := `C:\Users\Laurent\Google Drive (laurent.puig.ewin@gmail.com)\Sogetrel\Chantiers Poteau\2020-03-06 Remplacement\Polesite Sogetrel Poteau-Metz.xlsx`
