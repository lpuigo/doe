...
<div style="padding: 5px 25px">
    ...
    <el-row :gutter="10" type="flex" align="middle" class="doublespaced">
        <el-col :span="2" class="align-right">Client:</el-col>
        <el-col :span="6">
        ...
        <el-col :offset="1" :span="2" class="align-right">Référence du chantier:</el-col>
        <el-col :span="6">
	...
	<!-- Manager & Order Date -->
    <el-row :gutter="10" type="flex" align="middle" class="doublespaced">
        <el-col :span="2" class="align-right">Chargé d'affaire:</el-col>
        <el-col :span="6">
        ...
        <el-col :offset="1" :span="2" class="align-right">Date de commande:</el-col>
        <el-col :span="6">
	...
	<!-- Pulling Progress -->
    <el-row :gutter="10" type="flex" align="middle" class="doublespaced">
        <el-col :span="2" class="align-right">Total Tirage:</el-col>
        <el-col :span="15">
    ...
    <el-row :gutter="10" type="flex" align="middle" class="doublespaced">
        <el-col :offset="1" :span="2" class="align-right">Souterrain:</el-col>
        <el-col :span="14">
    ...
    <el-row :gutter="10" type="flex" align="middle" class="spaced">
        <el-col :offset="1" :span="2" class="align-right">Aérien:</el-col>
        <el-col :span="14">
    ...
    <el-row :gutter="10" type="flex" align="middle" class="spaced">
        <el-col :offset="1" :span="2" class="align-right">Façade:</el-col>
        <el-col :span="14">
	...
	<!-- Junction Progress -->
    <el-row :gutter="10" type="flex" align="middle" class="doublespaced">
        <el-col :span="2" class="align-right">Total Raccordement:</el-col>
        <el-col :span="15">
    ...
    <el-row :gutter="10" type="flex" align="middle" class="doublespaced">
        <el-col :offset="1" :span="2" class="align-right">Boitiers:</el-col>
        <el-col :span="14">
    ...
    <el-row :gutter="10" type="flex" align="middle" class="spaced">
        <el-col :offset="1" :span="2" class="align-right">Epissures:</el-col>
        <el-col :span="14">
...
func (rium *RipInfoUpdateModel) SetPullingStats() int {
	tot, und, aer, build := rium.Ripsite.GetPullingProgresses()
