...
<el-container style="height: 100%">
	...
	<el-main  style="height: 100%; padding: 0px">
		...
		>
			...
			>        
				<template slot-scope="scope">
                    <div class="header-menu-container">
                        <span @click="OpenFoaSite(scope.row.Id)" class="link">{{scope.row.Ref}}</span>
						<div>
            ...
            >
                <template slot-scope="scope">
                    <ripsiteinfo-progress-bar :total="scope.row.NbFoa" :blocked="scope.row.NbFoaBlocked" :done="scope.row.NbFoaDone"></ripsiteinfo-progress-bar>
                </template>
            </el-table-column>
